...
public class Textures {
    ...
    public static final HashMap<String, Supplier<TextureAtlasSprite>> texCreators = new HashMap<>();
    ...
    public static ModelResourceLocation getModelResourceLocation(Item item, int metadata) {
        ...
        return new ModelResourceLocation(Item.REGISTRY.getNameForObject(item) + "_", "inventory");
    }
