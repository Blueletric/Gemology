...
import blue.technicallygems.network.NetworkHandler;
import blue.technicallygems.network.TGPacketClientToServer;
...
public interface ILeftClickHandler {
    ...
    public static class PacketSendLeftClick extends TGPacketClientToServer {
        static {
